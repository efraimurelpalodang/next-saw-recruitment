  ...
  return (
    <div className="animate-in fade-in duration-500 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Table List View */}
        <div className="lg:col-span-2 bg-white rounded-[7px] border border-[#e5eaef] shadow-sm p-6">
           <div className="flex items-center justify-between mb-6">
             <h3 className="font-bold text-[#2a3547]">Daftar Lamaran Terbaru</h3>
             <button className="text-xs font-bold text-[#fccf54] hover:underline flex items-center gap-1">
                 ...
                 {[
                   ...
                   <tr key={i} className="hover:bg-gray-50/50 transition-colors">
                     <td className="py-4 flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-[#f2f6fa] flex items-center justify-center font-bold text-xs text-[#5a6a85]">
                          {item.name.charAt(0)}
                        </div>
                     ...
                     <td className="py-4 text-right">
                        <span className={`text-[11px] font-bold px-3 py-1 rounded-[4px] ${item.bg}`}>
                           {item.score}
                        </span>
                     </td>
                   </tr>
        ...
        <div className="space-y-6">
           <div className="bg-white rounded-[7px] border border-[#e5eaef] shadow-sm p-6 text-center">
              ...
              <button className="w-full py-2 bg-[#fccf54] text-[#2a3547] rounded-[7px] text-xs font-bold shadow-sm hover:opacity-90 transition-all">
                Mulai Sekarang
              </button>
           </div>
           ...
           <div className="bg-[#2a3547] rounded-[7px] p-6 text-white text-center flex flex-col items-center">
              ...
              <button className="w-full py-2 bg-transparent border border-[#fccf54] text-[#fccf54] rounded-[7px] text-xs font-bold hover:bg-[#fccf54] hover:text-[#2a3547] transition-all">
                 Review Ranking
              </button>
           </div>
        </div>
