...
export default function KontenManajer({ pengguna }: KontenManajerProps) {
  return (
    <div className="animate-in fade-in duration-500 space-y-6 text-[#2a3547]">
      ...
      <section className="bg-white rounded-[7px] border border-[#f5f2f2] shadow-xs flex flex-col lg:flex-row overflow-hidden">
         <div className="p-8 flex-1 space-y-4">
            ...
            <div className="flex gap-3 pt-2">
               <button className="px-5 py-2.5 bg-[#fccf54] text-[#2a3547] rounded-[7px] text-xs font-bold shadow-sm hover:cursor-pointer transition-all">
                  Generate Laporan SAW
               </button>
               <button className="px-5 py-2.5 bg-[#f2f6fa] text-[#2a3547] rounded-[7px] text-xs font-bold hover:bg-[#e5eaef] hover:cursor-pointer transition-all flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
         {/* Decision Feed Card */}
         <div className="bg-white rounded-[7px] border border-[#f5f2f2] shadow-xs p-6 overflow-hidden">
            ...
            <button className="w-full mt-6 py-2.5 bg-gray-50 text-[#5a6a85] rounded-[7px] text-[11px] font-bold hover:bg-[#2a3547] hover:text-white hover:cursor-pointer transition-all">
               View Full Queue
            </button>
         </div>

         {/* Managerial Notice Mockup */}
         <div className="bg-white rounded-[7px] border border-[#f5f2f2] shadow-xs p-6 space-y-4">
